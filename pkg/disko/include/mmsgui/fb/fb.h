/***********************************/
/* copied from linux kernel 2.6.28 */
/*  - kernel specific code removed */
/*  - types changed                */
/***********************************/
...
struct fb_fix_screeninfo {
	...
	unsigned short int reserved[3];		/* Reserved for future compatibility */
};
...
struct fb_cmap {
	...
	unsigned short int *red;			/* Red values	*/
	unsigned short int *green;
	unsigned short int *blue;
	unsigned short int *transp;			/* transparency, can be NULL */
};
...
struct fb_vblank {
	unsigned int flags;			/* FB_VBLANK flags */
	unsigned int count;			/* counter of retraces since boot */
	unsigned int vcount;			/* current scanline position */
	unsigned int hcount;			/* current scandot position */
...
struct fb_fillrect {
	unsigned int dx;	/* screen-relative */
	unsigned int dy;
	unsigned int width;
	unsigned int height;
	unsigned int color;
...
struct fb_image {
	unsigned int dx;		/* Where to place image */
	unsigned int dy;
	unsigned int width;		/* Size of image */
	unsigned int height;
	unsigned int fg_color;		/* Only used when a mono bitmap */
...
struct fb_cursor {
	unsigned short int set;		/* what to set */
	unsigned short int enable;		/* cursor on/off */
	unsigned short int rop;		/* bitop operation */
