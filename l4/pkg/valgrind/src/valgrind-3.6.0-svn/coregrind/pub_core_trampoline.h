...
#if defined(VGO_l4re)
extern void VG_(x86_l4re_SUBST_FOR_sigreturn);
extern void VG_(x86_l4re_SUBST_FOR_rt_sigreturn);
extern Char* VG_(x86_l4re_REDIR_FOR_index) ( const Char*, Int );
extern void VG_(x86_l4re_REDIR_FOR_syscall_page)(void);
